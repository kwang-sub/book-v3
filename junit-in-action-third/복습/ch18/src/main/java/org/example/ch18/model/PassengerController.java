 ...
 * ========================================================================
 */
package org.example.ch18.model;
...
public class PassengerController {
    ...
    Passenger findPassenger(@PathVariable(name = "id") Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new PassengerNotFoundException(id));
    }

    @PatchMapping("/passengers/{id}")
    Passenger patchPassenger(@RequestBody Map<String, String> updates, @PathVariable(name = "id") Long id) {
    ...
    void deletePassenger(@PathVariable(name = "id") Long id) {
